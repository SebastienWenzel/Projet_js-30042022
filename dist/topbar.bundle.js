...
const headerMenu = document.querySelector(".header-menu"); // Cette propriété permettra de savoir si le menu est ouvert :

let isMenuOpen = false; // Cette propriété permettra de savoir si le menu mobile est créé :

let mobileMenuDOM; // Pour fermer le menu il suffit d’enlever la classe open sur le menu :
